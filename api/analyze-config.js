...
SUMMARY: Write 2–3 sentences in a warm, direct tone. Critically evaluate & give your hontest take on the situation, what works or doesnt, things to be more observant on going forward if there are. Keep it candid. Describe how the bond will shape out if things continue as is. Write for the couple — no jargon, no references to scores or analysis methods.
...

{
  ...
  "summary": "Write 2-3 sentences in a warm direct tone. Critically evaluate & give your honest take on the situation. What works or doesnt, things to be more observant on going forward if there are. Keep it candid. Describe how the bond will shape out if things continue as is.",
  "actionables": {
