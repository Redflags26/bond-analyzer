export default async function handler(req, res) {
  ...
  const { recipients, analytics } = req.body;

  try {
    if (!recipients || !recipients.length || !analytics)
      throw new Error("Missing recipients or analytics data.");
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#faf9f5;border:1px solid #e7e5e4;border-radius:12px;">
              ...
              <tr>
                <td style="padding:4px 20px 8px 20px;">
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">${statsRows}</table>
                </td>
              </tr>
              ${actionItems ? `
              <tr>
                <td style="padding:0 20px 6px 20px;border-top:1px solid #e7e5e4;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">${actionItems}</table>
                </td>
              </tr>` : ''}
            </table>
          </td>
...
<body style="margin:0;padding:0;background:#f5f4f0;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f5f4f0;">
    <tr>
      <td align="center" style="padding:28px 12px;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background:#ffffff;border-radius:16px;border:1px solid #e7e5e4;overflow:hidden;">
          ...
          <!-- SUMMARY + SCORE -->
          <tr>
            <td class="section-pad" style="padding:28px 32px;border-bottom:1px solid #f0eeea;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
          ...
          <tr>
            <td class="section-pad" style="padding:24px 32px;border-bottom:1px solid #f0eeea;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">${metricRows}</table>
            </td>
          </tr>
          ...
          <tr>
            <td class="section-pad" style="padding:24px 32px;border-bottom:1px solid #f0eeea;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0">${profileCards}</table>
            </td>
          </tr>

          <!-- TAKEAWAY -->
          <tr>
            <td class="section-pad" style="padding:24px 32px;">
    ...
    if (failed.length) {
      ...
      throw new Error(errData.message || "One or more emails failed to send");
    }
